...
def create_model(word_info_sz=128, sentence_info_sz=200):
    model = Sequential()
...
word_sz_list = [30, 45, 60, 80]
sentence_sz_list = [50, 65, 70, 90]
...
for word_sz in word_sz_list:
    for sentence_sz in sentence_sz_list:
        ...
        print(f"#### WORD SZ - {word_sz}, SENTENCE_SZ - {sentence_sz} ####")
